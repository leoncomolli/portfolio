  ...
  return (
    <div className="min-h-screen bg-black text-white py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Header del proyecto */}
        <div className="mb-12">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">Agrofina - Empresa de agroquímicos</h1>
          <p className="text-xl text-gray-400">Detalles del proyecto</p>
        </div>
