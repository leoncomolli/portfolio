              ...
              <div className="text-center space-y-4 w-full">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-3">
                  ...
                  <a
                    ...
                    className="group flex items-center justify-center gap-3 px-6 py-3 bg-transparent border border-white/80 rounded-full hover:border-white hover:shadow-lg hover:shadow-white/20 hover:scale-105 transition-all duration-300 cursor-pointer"
                  >
